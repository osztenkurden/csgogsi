...
class CSGOGSI {
    ...
    digest(raw) {
        ...
        if (((_a = this.last) === null || _a === void 0 ? void 0 : _a.map.name) !== ((_b = raw.map) === null || _b === void 0 ? void 0 : _b.name)) {
            this.damage = [];
        }
        ...
        for (const player of players) {
            ...
            const damageEntries = damageForRound.map(damagex => { var _a; return ((_a = damagex.players.find(playerDamage => playerDamage.steamid === player.steamid)) === null || _a === void 0 ? void 0 : _a.damage) || 0; });
