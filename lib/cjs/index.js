        ...
        this.digest = (raw) => {
            ...
            if (raw.round && raw.map && raw.map.round_wins) {
                ...
                for (let i = 1; i <= currentRound; i++) {
                    const result = (0, utils_js_1.getRoundWin)(currentRound, { ct: teamCT, t: teamT }, raw.map.round_wins, i, this.regulationMR, this.overtimeMR);
                    if (!result)
                        continue;
                    rounds.push(result);
                }
            ...
            const data = {
                ...
                bomb: bomb
                    ...
                    : null,
                grenades: (0, utils_js_1.parseGrenades)(raw.grenades),
                phase_countdowns: {
